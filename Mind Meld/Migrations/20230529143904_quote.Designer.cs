...
namespace Mind_Meld.Migrations
{
    ...
    [Migration("20230529143904_quote")]
    partial class quote
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mind_Meld.Models.PurchRequest", b =>
                {
                    b.Property<int>("RequestID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PurchRequest");
                });

            modelBuilder.Entity("Mind_Meld.Models.Quote", b =>
                {
            ...
            modelBuilder.Entity("Mind_Meld.Models.PR_DTL", b =>
                {
                    b.HasOne("Mind_Meld.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProdID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Mind_Meld.Models.PurchRequest", "PurchRequest")
                        .WithMany()
                    ...
                    b.Navigation("PurchRequest");
                });

            modelBuilder.Entity("Mind_Meld.Models.Product", b =>
                {
                    b.HasOne("Mind_Meld.Models.Supplier", "Supplier")
                        .WithMany()
